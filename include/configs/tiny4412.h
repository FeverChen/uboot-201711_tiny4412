...
#define CONFIG_ENV_OFFSET		(0x6200) /* part 0.5+BL1 8+ BL2 16K */
...
#define PARTS_DEFAULT \
	...
	"name="PARTS_KERNEL",size=20MiB,uuid=${uuid_gpt_"PARTS_KERNEL"};" \
	"name="PARTS_FDT",start=2MiB,size=1MiB,uuid=${uuid_gpt_"PARTS_FDT"};" \
	"name="PARTS_RAMDISK",size=100MiB,uuid=${uuid_gpt_"PARTS_RAMDISK"};" \
	"name="PARTS_ROOTFS",size=2000MiB,uuid=${uuid_gpt_"PARTS_ROOTFS"};" \
...
#define CONFIG_DFU_ALT \
	...
	"/uImage ext4 0 2;" \
	"/modem.bin ext4 0 2;" \
	"/exynos4412-tiny4412.dtb ext4 0 2;" \
	""PARTS_KERNEL" part 0 1;" \
	""PARTS_FDT" part 0 2;" \
	""PARTS_RAMDISK" part 0 3;" \
	""PARTS_ROOTFS" part 0 4;" \
	""PARTS_USER" part 0 5;" \
...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"uartpath=ap\0" \
	"usbpath=ap\0" \
	"consoleon=set console console=ttySAC0,115200n8; save; reset\0" \
